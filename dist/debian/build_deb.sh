...
./scripts/git-archive-all --extra version --force-submodules --prefix scylla-enterprise-tools ../scylla-enterprise-tools_$SCYLLA_VERSION-$SCYLLA_RELEASE.orig.tar.gz
